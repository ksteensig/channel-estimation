...
# define model
    model = keras.Sequential([
            ...
            #keras.layers.Dense(K, activation='sigmoid', activity_regularizer=tf.keras.regularizers.l2(0.01))
            ])
    ...
    model.save(f"models/users_{K}_bits_{L}_sgd_lr_{learning_rate}_momentum_{momentum}")
